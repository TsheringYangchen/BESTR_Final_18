	...
	<nav class="navbar navbar-expand-md navbar-dark py-0 fixed-top" style="background-color:#40739e;">
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"> <a class="nav-link mx-3" href="{{url('/vacancy-announcement')}}">Announcement</a> </li>
				<li class="nav-item"> <a class="nav-link" href="{{url('/application')}}">License Application</a> </li>
			</ul>
			<ul class="navbar list-unstyled">
				<li class="nav-item"> <a class="nav-link text-white" href="{{url('/admin-login')}}">ADMIN</a> </li>
			</ul>
		</div>
	</nav>
	<br>
	...
	<div class="container">
		<div class="vertical-nav bg-white" id="sidebar">
			<ul class="nav flex-column mb-0">
				<li class="nav-item"> <a href="vacancy-announcement" class="nav-link text-dark mr-3 pt-5">
                             VACANCY ANNOUNCEMENT
                        </a> </li>
				<br>
				<li class="nav-item"> <a href="tender-announcement" class="nav-link text-dark mr-3">
                                TENDER ANNOUNCEMENT
                        </a> </li>
				<br>
				<li class="nav-item"> <a href="training-announcement" class="nav-link text-dark mr-3">
                                TRAINING ANNOUNCEMENT
                        </a> </li>
				<br>
				<li class="nav-item"> <a href="general-announcement" class="nav-link text-dark mr-3">
