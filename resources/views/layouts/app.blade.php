...
<body>
	...
	<nav class="navbar navbar-expand-md navbar-dark py-0 fixed-top" style="background-color:#40739e;">
		...
		<div class="collapse navbar-collapse" id="collapsibleNavbar">
			<ul class="navbar-nav mr-auto" style="font-family: Verdana, Geneva, Tahoma, sans-serif">
			...
			<ul class="navbar list-unstyled">
				<li class="nav-item"> <a class="nav-link text-white" href="{{url('/admin-login')}}" style="font-family: Verdana, Geneva, Tahoma, sans-serif">Login</a> </li>
			</ul>
		</div>
	</nav>
	<br>
